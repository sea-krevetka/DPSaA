...
int main() {
    ...
    printf("         D      R       G                  D      R       G\n");
    SkitfactBubble(100); MoreSpaces(15); SkitfactShaker(100);
    SkitfactBubble(200); MoreSpaces(14); SkitfactShaker(200);
    SkitfactBubble(300); MoreSpaces(12); SkitfactShaker(300);
    SkitfactBubble(400); MoreSpaces(12); SkitfactShaker(400);
    SkitfactBubble(500); MoreSpaces(11); SkitfactShaker(500);
