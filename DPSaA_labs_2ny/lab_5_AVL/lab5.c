...
int main() {
    ...
    printf("=== УДАЛЕНИЕ ВЕРШИН ИЗ АВЛ-ДЕРЕВА ===\n\n");
    ...
    printf("Эксперимент с добавлением 50 вершин:\n");
    printf("Количество поворотов: %d\n", test_rotations);
    printf("Соотношение поворотов/включений: %.2f\n", (float)test_rotations / 50);
    printf("Утверждение: на каждые два включения встречается один поворот (ожидаемое ~25)\n");
    ...
    printf("\nЭксперимент с удалением 10 вершин:\n");
    printf("Количество поворотов: %d\n", test_delete_rotations);
    printf("Соотношение поворотов/удалений: %.2f\n", (float)test_delete_rotations / 10);
    printf("Утверждение: поворот происходит в одном случае из пяти (ожидаемое ~2)\n");
